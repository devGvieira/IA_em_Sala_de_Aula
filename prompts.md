...
> Você é um coordenador pedagógico especialista em IA aplicada à educação básica. Gere um **plano de aula completo** para **Matemática, 6º ano (32 alunos)** sobre **“Frações e Representações Visuais”** com **50 minutos** de duração.
> Entregue as seções: **Título, Contexto, Objetivos de aprendizagem (mensuráveis, “o estudante será capaz de…”), Habilidades/Competências, Conteúdo Programático, Metodologia passo a passo (minutagem sugerida), Recursos (incluindo onde a IA entra), Avaliação (inclua uma rubrica em tabela com critérios e níveis: Excelente, Bom, A melhorar), Diferenciação/Adaptações, Referências.**
> Em cada seção que for proposta por você (IA), insira a tag **[Assistido por IA]** para garantir transparência. Linguagem clara, nivelada para 6º ano, sem dados pessoais.
...
> Em seguida, **selecione um trecho de 120–150 palavras** do material e gere **revisão inteligente + tradução para Inglês (CEFR A2)**. Adicione uma breve nota: “Como usar este trecho com estudantes multilíngues”. Marque a tradução com **[Assistido por IA – Tradução]**.
> Não inclua dados pessoais e padronize a linguagem para o público do **6º ano**.
...
>   Em cada item criado por você, inclua **[Assistido por IA]** e, quando pertinente, um **alerta ético/autorais** (ex.: evitar uso de imagens com licença restrita).
...
>   Ao final do README, gere também uma **reflexão crítica** (400–600 palavras) sobre o uso de IA neste projeto (ferramentas, ética/privacidade, ganhos de tempo, personalização, lições aprendidas). Marque trechos gerados por IA com **[Assistido por IA]**.
